<!-- delete moadal -->
<div class="modal fade" id="client-del-model" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <button id="delete-client" type="button" class="btn btn-danger">Delete</button>
        </div>
    </div>
</div>
</div>
...
<script>
    function clientdeletemodalShow(event) {
            ...
            let deleteBtnModal = document.querySelector("#delete-client");
