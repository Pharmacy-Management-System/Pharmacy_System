{{-- <div class="modal fade" id="create-order" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form method="POST" action="{{route('medicines.store')}}" id="create-form" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input name="name" class="form-control" id="create_medName" value="">
                    </div>
                    <div class="mb-3">
                        <label for="medType" class="form-label">Medicine Type</label>
                        <input name="type" class="form-control" id="create_medType" value="">
                    </div>
                    <div class="mb-3">
                        <label for="medQuntity" class="form-label">Medicine Quantity</label>
                        <input name="quantity" class="form-control" id="create_medQuntity" value="">
                    </div>
                    <div class="mb-3">
                        <label for="medPrice" class="form-label">Price of one Item</label>
                        <input name="price" class="form-control" id="create_medPrice" value="">
                    </div>
                </div>
