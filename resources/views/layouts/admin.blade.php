...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.tailwindcss.com/dark.css">
...
<body class="font-sans antialiased bg-gray-100 dark:bg-gray-800">
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen bg-gray-100 dark:bg-gray-800">
        ...
        <div class="flex w-full md:flex bg-slate-50">{{$slot}}</div>
    </div>
