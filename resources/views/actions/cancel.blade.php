...
<body>
    <div class="container w-50 p-5 border shadow-lg rounded-5" style="margin-top: 150px;">
        ...
        @if ($state == "Canceled")
            <p><Strong>Your order is already Cancelled</Strong></p>
            <p class="mt-5">Thank You for using our website..</p>
        @elseif ($state == "WaitingForUserConfirmation")
            <p><Strong>Your order is cancelled successfully!</Strong></p>
            <p class="mt-5">Thank You for using our website..</p>
        @elseif ($state == "Confirmed")
            <p><Strong>You can't cancel your order. It's already confirmed or delivered..</Strong></p>
            <p class="mt-5">Thank You for using our website..</p>
       @endif
    </div>
